...
export declare function getLengthAtKey(db: any, key: Buffer): Promise<number>;
export declare class IndexSandbox extends EventEmitter {
    ...
    __get(blockTag: string, k: number, v: number): Promise<void>;
    __get_len(blockTag: string, k: number): Promise<number>;
    abort(): void;
    setInput(input: string): IndexSandbox;
    run(symbol: string, blockTag: string): Promise<any>;
}
